...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">front-urbs documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-d38f77a2f065a4e19b6384524dd4c707"' : 'data-target="#xs-components-links-module-AppModule-d38f77a2f065a4e19b6384524dd4c707"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-d38f77a2f065a4e19b6384524dd4c707"' :
                                            'id="xs-components-links-module-AppModule-d38f77a2f065a4e19b6384524dd4c707"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/CategoriasCadastroComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">CategoriasCadastroComponent</a>
                                            </li>
                                            <li class="link">
